...
const geoCode = ((address, callback) => {
    const url = 'https://api.mapbox.com/geocoding/v5/mapbox.places/' + address + '.json?access_token=pk.eyJ1Ijoiam9obnNubm5ubm93IiwiYSI6ImNrZmNwNm5sYzFpMzAyeW1xcXU3ZDljZ2kifQ.xNSnP7mlEM3ymg9ukY-EBA&limit=1'
